...
struct State
{
	...
	State( int seconds,
	       ...
	       int number_refineries,
	       int number_pylons,
	       const std::map<std::string, std::pair<int, int> > &resources,
	       const std::vector< ActionData > &busy,
	       const std::vector< ActionPrep > &in_move )
		: seconds(seconds),
