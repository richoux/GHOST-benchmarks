...
(cd magic_hexagon && ./bin/magic_hexagon 3 2> /dev/null && ./bin/min_magic_hexagon 3 2> /dev/null && ./bin/magic_hexagon 4 1 1 2> /dev/null && ./bin/min_magic_hexagon 4 1 1 2> /dev/null)
