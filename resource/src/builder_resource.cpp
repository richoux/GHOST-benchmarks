...
{
	create_variable( 0, _supply / 2 + 1, "Zealot" );
	create_variable( 0, _supply / 2 + 1, "Dragoon" );
	create_variable( 0, _supply / 2 + 1, "DarkTemplar" );
	create_variable( 0, _supply / 4 + 1, "Reaver" );
	create_variable( 0, _supply / 3 + 1, "Scout" );
}
...
{
	create_variable( 0, _supply * 2 + 1, "Zergling" );
	create_variable( 0, _supply + 1, "Hydralisk" );
	create_variable( 0, _supply / 2 + 1, "Lurker" );
	create_variable( 0, _supply / 4 + 1, "Ultralisk" );
	create_variable( 0, _supply / 2 + 1, "Mutalisk" );
	create_variable( 0, _supply / 2 + 1, "Guardian" );
}
